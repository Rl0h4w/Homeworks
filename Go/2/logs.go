...
func (log *AppLog) PrintInfo() string {
...
func main() {
	var input string = "2025-01-13 12:45:33 DEBUG [App5] Cache miss for 'user_123' on request to endpoint /user/profile"
	...
	fmt.Println(appLog.PrintInfo())
	fmt.Println(appLog.GetSeverity())
}
